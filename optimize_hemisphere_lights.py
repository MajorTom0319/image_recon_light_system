...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--lr_scale", type=float, default=0.05)
    parser.add_argument("--max_intensity", type=float, default=1e6)

    parser.add_argument("--mse_weight", type=float, default=1.0)
    parser.add_argument("--l1_weight", type=float, default=1.0)
    parser.add_argument("--energy_weight", type=float, default=1e-6)
    parser.add_argument("--color_weight", type=float, default=1e-5)
